...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        estados = [
            ('nueva',          'Nueva',           '#64748b', 1),
            ('en_cotizacion',  'Cotización',   '#f59e0b', 2),
            ('cotizada',       'Cotizada',         '#8b5cf6', 3),
            ('en_negociacion', 'En Negociación',   '#06b6d4', 4),
            ('asignada',       'Asignada',         '#6366f1', 5),
            ('en_progreso',    'En Progreso',      '#14b8a6', 6),
            ('en_revision',    'En Revisión',      '#ec4899', 7),
            ('completada',     'Completada',       '#22c55e', 8),
            ('en_correccion',  'En Corrección',    '#f97316', 9),
            ('cancelada',      'Cancelada',        '#ef4444', 10),
            ('en_disputa',     'En Disputa',       '#991b1b', 11),
        ]
