...
urlpatterns = [
    ...
    path('app/blog/', views.blog_admin_list, name='blog_admin_list'),
    path('app/blog/crear/', views.blog_admin_crear, name='blog_admin_crear'),
    path('app/blog/<int:pk>/editar/', views.blog_admin_editar, name='blog_admin_editar'),
    path('app/blog/<int:pk>/eliminar/', views.blog_admin_eliminar, name='blog_admin_eliminar'),
